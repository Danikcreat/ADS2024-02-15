...
/**
 * Класс MySplayMap реализует интерфейс NavigableMap, используя структуру данных Splay Tree (сплай-дерево).
 * Сплай-дерево автоматически "подтягивает" узлы, к которым обращаются чаще всего, к корню дерева,
 * что улучшает производительность для часто используемых элементов.
 */
public class MySplayMap implements NavigableMap<Integer, String> {
     ...
     * Каждый узел содержит ключ (key), значение (value), ссылки на левого и правого потомков,
     * а также на родительский узел (для удобства реализации операций вращения).
     */
    class Node {
        Integer key;
        String value;
    ...
    /**
     * Метод toString возвращает строковое представление карты.
     * Ключи и значения перечисляются в порядке возрастания ключей (in-order traversal).
     */
    @Override
    ...
    /**
     * Рекурсивный обход дерева в порядке возрастания ключей (in-order traversal).
     */
    ...
    /**
     * Возвращает размер дерева (количество узлов).
     */
    @Override
    public int size() {
        return size(Root);
    ...
    /**
     * Проверяет наличие заданного ключа в дереве.
     */
    @Override
    ...
    /**
     * Проверяет наличие заданного значения в дереве.
     */
    @Override
    ...
    /**
     * Возвращает значение, связанное с заданным ключом. При этом ключ "подтягивается" к корню дерева.
     */
    @Override
    ...
    /**
     * Добавляет новую пару ключ-значение в дерево. При этом узел с новым ключом становится корнем.
     */
    @Override
